...
<main id="content" role="main">
    ...
    <div class="position-relative bg-white overflow-hidden">
        <div class="container position-relative z-index-2 space-top-3 space-top-lg-4 space-bottom-2 space-bottom-md-3">
            <div class="row align-items-lg-center">
                ...
                "backDelay": 1500
                        ...
                        <p class="text-white-70">Much more than a bank, Front is the ideal, fastest and most convenient
                            financial and administrative co-driver to work with peace of mind.</p>
                    </div>

                    <a class="btn btn-light btn-wide btn-pill shadow-soft transition-3d-hover mb-2 mb-sm-0 mr-4"
                        href="#">Contact Sales</a>
                    <a class="btn btn-indigo btn-wide btn-pill transition-3d-hover mb-2 mb-sm-0" href="#">Get
                        Started</a>
                    <!-- End Info -->
                </div>
                ...
                <div class="col-lg-7">
                    <div class="position-relative">
                        ...
                        <div class="device d-none d-sm-block mb-3 mb-sm-0" data-aos="fade-up">
                            <img class="img-fluid" src="https://htmlstream.com/front/assets/svg/components/macbook.svg"
                                alt="Image Description">
                            <img class="device-macbook-screen"
                                src="https://htmlstream.com/front/assets/img/1618x1010/img3.jpg"
                                alt="Image Description">
                        </div>
                        <!-- End Device Mockup -->

                        <!-- Card Info -->
                        <div class="position-sm-absolute bottom-0 right-0 max-w-sm-40rem mx-auto ml-sm-auto mb-sm-n5"
                            data-aos="fade-up" data-aos-delay="100">
                            <div class="card bg-indigo">
                                <div class="card-body">
                                    <h2 class="h5 text-white mb-3">Integrate<br>quickly</h2>

                                    <p class="text-info">Front lets you spend your development time on product
                                        improvements.</p>
                                    ...
                                    <div class="media align-items-center">
                                        <div class="avatar avatar-xs avatar-circle mr-2">
                                            <img class="avatar-img"
                                                src="https://htmlstream.com/front/assets/img/100x100/img3.jpg"
                                                alt="Image Description">
                                        </div>
        ...
        <figure class="d-none d-md-block position-absolute"
        ...
        <div class="row justify-content-lg-between align-items-lg-center">
            <div class="col-lg-5 mb-9 mb-lg-0">
                <div class="mb-5">
                    ...
                    <p>When paying in stores, Front Pay doesn't share your actual card number, so your information stays
                        secure. Plus, you can check out faster and easier.</p>
                </div>

                <div class="w-md-50 w-lg-80 mb-2">
                    <!-- Fancybox -->
                    <div class="bg-img-hero text-center rounded-lg py-11 px-5"
                        style="background-image: url(https://htmlstream.com/front/assets/img/480x320/img18.jpg);">
                        <a class="js-fancybox video-player video-player-btn d-flex justify-content-center align-items-center"
         ...
         "vimeo": {
           "autoplay": 1
            ...
            <div class="col-lg-6">
                <div class="position-relative max-w-50rem mx-auto" data-aos="fade-up">
                    <!-- Device Mockup -->
                    <div class="device device-iphone-x w-75 mx-auto">
                        <img class="device-iphone-x-frame"
                            src="https://htmlstream.com/front/assets/svg/components/iphone-x.svg"
                            alt="Image Description">
                        <img class="device-iphone-x-screen"
                            src="https://htmlstream.com/front/assets/img/407x867/img8.jpg" alt="Image Description">
                    </div>
                    <!-- End Device Mockup -->
                    ...
                    <div class="position-absolute bottom-0 right-0 max-w-50rem w-100 z-index-n1 mx-auto">
                        <img class="img-fluid"
                            src="https://htmlstream.com/front/assets/svg/components/abstract-shapes-2.svg"
                            alt="Image Description">
                    </div>
                    <!-- End SVG Component -->
                </div>
        ...
        <div class="row justify-content-lg-between align-items-lg-center">
            <div class="col-lg-5 order-lg-2 mb-9 mb-lg-0">
                <div class="mb-5">
                    ...
                    <p>Use Front Pay to make purchases in all kinds of apps. Pay for a ride, a pizza delivery, or a new
                        pair of sneakers — with just a touch. Checking out is fast, simple, and secure.</p>
                </div>
                ...
                <div class="position-relative max-w-50rem mx-auto" data-aos="fade-up">
                    ...
                    <div class="device device-iphone-x w-75 mx-auto">
                        <img class="device-iphone-x-frame"
                            ...
                            alt="Image Description">
                        <img class="device-iphone-x-screen"
                            src="https://htmlstream.com/front/assets/img/407x867/img9.jpg" alt="Image Description">
                    </div>
                    <!-- End Device Mockup -->
                    ...
                    <div class="position-absolute bottom-0 right-0 max-w-50rem w-100 z-index-n1 mx-auto">
                        <img class="img-fluid"
                            src="https://htmlstream.com/front/assets/svg/components/abstract-shapes-3.svg"
                            alt="Image Description">
                    </div>
                    <!-- End SVG Component -->
                </div>
        ...
        <div class="row justify-content-lg-between align-items-lg-center">
            <div class="col-lg-5 mb-9 mb-lg-0">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <p>When you pay with a debit or credit card, Front Pay doesn't keep transaction information that
                            can be tied back to you.</p>
                    </div>
                </div>
                <div class="media">
                    <span class="icon icon-xs icon-indigo icon-circle mt-1 mr-3">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <p>You can also add your student ID card to Front Wallet to access places like your dorm and the
                            library.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="position-relative max-w-50rem mx-auto" data-aos="fade-up">
                    ...
                    <div class="device device-iphone-x w-75 mx-auto">
                        <img class="device-iphone-x-frame"
                            ...
                            alt="Image Description">
                        <img class="device-iphone-x-screen"
                            src="https://htmlstream.com/front/assets/img/407x867/img1.jpg" alt="Image Description">
                    </div>
                    <!-- End Device Mockup -->
                    ...
                    <div class="position-absolute bottom-0 right-0 max-w-50rem w-100 z-index-n1 mx-auto">
                        <img class="img-fluid"
                            src="https://htmlstream.com/front/assets/svg/components/abstract-shapes-4.svg"
                            alt="Image Description">
                    </div>
                    <!-- End SVG Component -->
                </div>
    ...
    <div class="container space-2 space-lg-3">
        ...
        <div class="w-lg-50 text-center mx-lg-auto mb-5 mb-md-9">
            ...
            <p>Once you're setup, instantly withdraw payments or deposit into your bank account within 2-3 business
                days.</p>
        </div>
        <!-- End Title -->
        ...
        <div class="row no-gutters align-items-lg-center mb-7 mb-md-11">
            <div class="col-lg-7 shadow-lg rounded-lg">
                <div class="text-center py-11 px-5 px-sm-9">
                    ...
                    <div class="row justify-content-sm-center align-items-sm-center mb-5">
                        <div class="col-sm-5">
                            ...
                            <figure class="max-w-8rem mx-auto mb-2">
                                <img class="img-fluid"
                                    src="https://htmlstream.com/front/assets/svg/illustrations/account-creation.svg"
                                    alt="SVG">
                            </figure>
                        ...
                        <div class="col-sm-5">
                            ...
                            <figure class="max-w-8rem mx-auto mb-2">
                                <img class="img-fluid"
                                    src="https://htmlstream.com/front/assets/svg/illustrations/pro-account.svg"
                                    alt="SVG">
                            </figure>
                    ...
                    <button type="button" class="btn btn-primary btn-wide btn-pill transition-3d-hover">Get
                        Started</button>
                </div>
            </div>
                ...
                <div class="py-9 px-5 px-sm-9">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p class="text-white-70 mb-0">Use our libraries to collect payment information without
                                sensitive data.</p>
                        </div>
                    </div>
                    <!-- End Info -->
        ...
        <div class="w-lg-75 mx-lg-auto">
            <div class="media d-block d-sm-flex">
                <figure class="w-100 max-w-15rem mr-4 mb-3 mb-sm-0">
                    <img class="img-fluid"
                        src="https://htmlstream.com/front/assets/svg/illustrations/growing-business.svg" alt="SVG">
                </figure>
                <div class="media-body">
                    <h4>Grow your business with Front Pay</h4>
                    <p>From startups to Fortune 500s, explore how millions of businesses use Front Pay to start and
                        scale their companies.
                        <a class="font-weight-bold" href="#">See our customers <i
            ...
            <div class="card-deck d-block d-lg-flex card-lg-gutters-2">
                ...
                <div class="card shadow-none bg-transparent">
                    <div class="card-body">
                        ...
                        <div class="mb-auto">
                            <p class="mb-0">With Front Pay, you can check out across the web and in apps without having
                    ...
                    <div class="card-footer border-0 bg-transparent pt-0 px-5 pb-5">
                        <div class="media">
                            <div class="avatar avatar-circle mr-3">
                                <img class="avatar-img" src="https://htmlstream.com/front/assets/img/100x100/img2.jpg"
                                    alt="Image Description">
                            </div>
                            <div class="media-body">
                ...
                <div class="card bg-primary text-white shadow-primary-lg">
                    <div class="card-body">
                        ...
                        <div class="mb-auto">
                            <p class="text-white mb-0">From boarding passes to transit and movie tickets, there's pretty
                                much nothing you can't store with Front Pay.</p>
                        </div>
                    </div>
                    ...
                    <div class="card-footer border-0 bg-primary text-white pt-0 px-5 pb-5">
                        <div class="media">
                            <div class="avatar avatar-circle mr-3">
                                <img class="avatar-img" src="https://htmlstream.com/front/assets/img/100x100/img11.jpg"
                                    alt="Image Description">
                            </div>
                            <div class="media-body">
                ...
                <div class="card shadow-none bg-transparent">
                    <div class="card-body">
                        ...
                        <div class="mb-auto">
                            <p class="mb-0">I love Front Pay for cash back, reward points and fraud protection – just
                    ...
                    <div class="card-footer border-0 bg-transparent pt-0 px-5 pb-5">
                        <div class="media">
                            <div class="avatar avatar-circle mr-3">
                                <img class="avatar-img" src="https://htmlstream.com/front/assets/img/100x100/img4.jpg"
                                    alt="Image Description">
                            </div>
                            <div class="media-body">
                    ...
                    <div class="col-4 col-lg-2 mb-4 mb-lg-0">
                        <div class="mx-2">
                            <img class="max-w-11rem max-w-md-13rem mx-auto"
                                src="https://htmlstream.com/front/assets/svg/clients-logo/slack.svg"
                                alt="Image Description">
                        </div>
                    </div>
                    <div class="col-4 col-lg-2 mb-4 mb-lg-0">
                        <div class="mx-2">
                            <img class="max-w-11rem max-w-md-13rem mx-auto"
                                src="https://htmlstream.com/front/assets/svg/clients-logo/google.svg"
                                alt="Image Description">
                        </div>
                    </div>
                    <div class="col-4 col-lg-2 mb-4 mb-lg-0">
                        <div class="mx-2">
                            <img class="max-w-11rem max-w-md-13rem mx-auto"
                                src="https://htmlstream.com/front/assets/svg/clients-logo/spotify.svg"
                                alt="Image Description">
                        </div>
                    </div>
                    <div class="col-4 col-lg-2 mb-4 mb-lg-0">
                        <div class="mx-2">
                            <img class="max-w-11rem max-w-md-13rem mx-auto"
                                src="https://htmlstream.com/front/assets/svg/clients-logo/airbnb.svg"
                                alt="Image Description">
                        </div>
                    </div>
                    <div class="col-4 col-lg-2 mb-4 mb-lg-0">
                        <div class="mx-2">
                            <img class="max-w-11rem max-w-md-13rem mx-auto"
                                src="https://htmlstream.com/front/assets/svg/clients-logo/shopify.svg"
                                alt="Image Description">
                        </div>
                    </div>
                    <div class="col-4 col-lg-2 mb-4 mb-lg-0">
                        <div class="mx-2">
                            <img class="max-w-11rem max-w-md-13rem mx-auto"
                                src="https://htmlstream.com/front/assets/svg/clients-logo/netflix.svg"
                                alt="Image Description">
                        </div>
                    </div>
                </div>
    ...
    <!-- How To Section -->
    <div class="container space-2 space-top-lg-4 space-bottom-lg-3">
        <!-- Title -->
        <div class="w-lg-50 text-center mx-lg-auto mb-5">
            <h2>Simple and affordable.<br>Pay as you go.</h2>
            <p>From boarding passes to movie tickets, there's pretty much nothing you can't store with Front Pay. Plus,
                you can take your money further with exclusive offers, discounts, and even reminders to use your loyalty
                card when you enter the store.</p>
        </div>
        <!-- End Title -->

        <!-- Fancybox -->
        <div class="text-center mx-auto mb-11">
            <a class="js-fancybox" href="javascript:;" data-hs-fancybox-options='{
     ...
     "autoplay": 1
        ...
        <div class="row justify-content-md-center mb-11">
            <div class="col-md-4 col-lg-3 mb-9 mb-lg-0">
                ...
                <div class="step-dots text-center px-lg-4">
                    <figure class="max-w-10rem mx-auto mb-3">
                        <img class="img-fluid" src="https://htmlstream.com/front/assets/svg/icons/icon-48.svg"
                            alt="SVG">
                    </figure>
            ...
            <div class="col-md-4 col-lg-3 mb-9 mb-lg-0">
                ...
                <div class="step-dots text-center px-lg-4">
                    <figure class="max-w-10rem mx-auto mb-3">
                        <img class="img-fluid" src="https://htmlstream.com/front/assets/svg/icons/icon-39.svg"
                            alt="SVG">
                    </figure>
            ...
            <div class="col-md-4 col-lg-3">
                ...
                <div class="text-center px-lg-4">
                    <figure class="max-w-10rem mx-auto mb-3">
                        <img class="img-fluid" src="https://htmlstream.com/front/assets/svg/icons/icon-20.svg"
                            alt="SVG">
                    </figure>
        ...
        <div class="max-w-50rem mx-auto" data-aos="fade-up">
            <img class="img-fluid" src="https://htmlstream.com/front/assets/svg/illustrations/visa-card.svg"
                alt="Image Description">
        </div>
    </div>
    <!-- End How To Section -->
